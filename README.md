...
```bash
cd src && python make_eval_jsonl.py
```
...
## 5. Code route submission (no Key, recommended for a first pass)
...
## 6. 9/20 submission checklist (copy-paste into the Access Request)
